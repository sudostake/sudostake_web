        ...
        <div className="flex flex-col gap-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                <div
                    ...
                    <span className="text-green-600">Fixed interest rental</span> <br /> You can allow the lender to claim a fixed amount of staking rewards with optional voting rights that can be exercised by the lender during the rewards claiming process.
                </div>
                <div
                    className={classNames({
                        "px-4 py-8": true,
                    ...
                    <span className='text-blue-600'>Fixed term rental</span> <br /> You can allow the lender to claim all staking rewards for a fixed duration of time with optional voting rights that can be exercised by the lender during the rewards claiming process.
                </div>
                <div
                    className={classNames({
                        "px-4 py-8": true,
                    ...
                    <span className='text-red-600'>Fixed term loan</span> <br /> You can allow the lender to liquidate a fixed amount of your staked tokens when you default on the loan.
                </div>
            </div>
