...
import { get_connection, rpc_to_vault_code_ids_map } from '../services/vault_indexer';
...
export async function POST(req: NextRequest) {
    ...
    try {
        ...
        if (!rpc_to_vault_code_ids_map[req_data.rpc].includes(contract_data.codeId)) {
        ...
        set(`/vaults/${req_data.vault_address}`, contract_info);
