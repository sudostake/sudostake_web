    ...
    <section className="w-full pt-10 sm:pt-14 lg:pt-20">
      <div className="mx-auto w-full max-w-5xl">
        <div className="section-shell relative overflow-hidden bg-white/70 px-6 py-10 shadow-soft-elevated backdrop-blur-2xl dark:bg-zinc-950/55 sm:px-8 lg:px-12 lg:py-14">
          <div className="pointer-events-none absolute -left-28 -top-24 h-64 w-64 rounded-full bg-[color:var(--accent-primary)]/18 blur-3xl sm:-left-32 sm:-top-32 sm:h-72 sm:w-72" />
          <div className="pointer-events-none absolute -bottom-28 right-[-4rem] h-64 w-64 rounded-full bg-emerald-400/15 blur-3xl sm:h-80 sm:w-80 dark:bg-emerald-300/10" />
          ...
          <div className="flex flex-col gap-10">
            ...
            <div className="relative flex flex-col gap-6 rounded-3xl border border-[color:var(--border-soft)] bg-white/85 px-6 py-6 shadow-[0_32px_60px_-45px_rgba(15,23,42,0.55)] backdrop-blur dark:border-zinc-800/65 dark:bg-zinc-950/65">
