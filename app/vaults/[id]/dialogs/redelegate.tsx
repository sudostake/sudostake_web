                                ...
                                <Dialog.Panel className={classNames({
                                    ...
                                    <>
                                        ...
                                        <div className="relative flex w-full flex-wrap items-stretch mb-8">
                                            ...
                                            <span onClick={() => setAmount(selected_from_validator && selected_from_validator.delegated_amount)} role="button" className="right-0 mr-2 lg:mr-8 flex h-full leading-snug font-normal text-center text-xs lg:text-base items-center justify-center text-slate-100 absolute bg-transparent rounded  w-8 ">
                                                max
                                            </span>
                                        </div>
